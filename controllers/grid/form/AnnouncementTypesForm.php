...
/**
 * @file controllers/grid/form/AnnouncementTypesForm.inc.php
 *
 * Copyright Lara Marziali
 * Distributed under the GNU GPL v3. For full terms see the file LICENSE.
 *
 * @class AnnouncementTypesForm
 * @ingroup controllers_grid_??
 *
 * Form for press managers to create and modify sidebar blocks
 *
 */

namespace APP\plugins\generic\announcementBlocks\controllers\grid\form;

use APP\template\TemplateManager;
use PKP\db\DAORegistry;

//See https://github.com/pkp/staticPages/blob/175fbddcb2e86933f90360e78f5472873748644a/controllers/grid/form/StaticPageForm.php


class AnnouncementTypesForm extends \PKP\form\Form //to change?
{
    ...
    /** @var int array of Announcement by Type */
    public $arrayTypesId;

    /** @var AnnouncementBlockPlugin AnnouncementBLock plugin */
    public $plugin;

    /**
     * Constructor
     *
     * @param AnnouncementBlockPlugin $announcementBlockPlugin AnnouncementBLock plugin
     * @param int $contextId Context ID
     * @param int $arrayTypesId array of Announcement by Type
     */
    public function __construct($announcementBlockPlugin, $contextId, $arrayTypesId = null)
    {
        //parent::__construct($staticPagesPlugin->getTemplateResource('editStaticPageForm.tpl'));

        $this->contextId = $contextId;
        $this->arrayTypesId = $arrayTypesId;
        $this->plugin = $announcementBlockPlugin;

        // Add form checks TO DELETE?? 
    ...
    public function execute(...$functionParams)
    {
        ...
        $staticPagesDao = DAORegistry::getDAO('AnnouncementByTypesDAO');
        if ($this->staticPageId) {
