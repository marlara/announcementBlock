{**
   ...
   {assign var=announcementType value=$announcement->getAssocType()}
   ...
   <article class="announcement-summary">
       ...
       <div class="announcement-type">
        <span>{$announcement->getAnnouncementTypeName()|escape}</span>
        {* <a href="{url router=$smarty.const.ROUTE_PAGE page="announcement_type" op="view" path=$announcementType}"</a> *}
       </div>
   </article>
